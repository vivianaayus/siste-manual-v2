...
\item Repita los pasos (10) y (11) para hacer un alineamiento tipo FSO con \Cmd{transform(fixed\_states)} y pese la matriz morfol'ogica 2 veces el valor de los datos moleculares usando \Cmd{transform((static, weight:2))}.
