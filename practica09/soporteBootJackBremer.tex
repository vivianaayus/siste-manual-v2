...
\index{Soporte!parsimonia!Remuestro!Bootstrap}
\index{Soporte!parsimonia!Remuestro!Jack-knife}
\index{Soporte!parsimonia!Bremer}

\index{Soporte!ML!Bootstraping no param\'etrico}
...
% y en la \textbf{remuestreo sim\'etrico}
...
\item \textbf{En \Pname{TNT} y \Pname{NONA}:}
	\begin{enumerate}
		...
		\item Haga 500 r\'eplicas de Wagner sin permutar ramas, reteniendo solo un \'arbol por r\'eplica. Luego llene la pila de \'arboles haciendo permutaci\'on de ramas, use \Cmd{bbreak} en \Pname{TNT}, y en \Pname{NONA} \Cmd{max*;}.En \Pname{NONA} y \Pname{TNT} el soporte de Bremer se obtiene con \Cmd{bsupport}\\
