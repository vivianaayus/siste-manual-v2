...
Para un archivo de entrada de datos denominado $archivo$, el programa genera dos archivos de salida: $archivo$.phy$\_$phyml$\_$stats.txt (salida con los  estad\'isticos) y $archivo$.phy$\_$phyml$\_$tree.txt (salida con  el \'arbol en notaci\'on \Pname{Newick} o \Pname{PHYLIP}). Estos dos archivos en caso de existir pueden ser sobreescritos (R) o la salida actual puede ser a\~nadida a una salida previa (O).
